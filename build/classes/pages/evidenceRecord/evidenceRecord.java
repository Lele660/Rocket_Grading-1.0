...
public class evidenceRecord extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        gridPane.add(labelU1, 4, 2, 1, 1);
        gridPane.add(labelB, 5, 2, 1, 1);
        gridPane.add(labelA1, 6, 2, 1, 1);
        gridPane.add(labelB1, 7, 2, 1, 1);
        gridPane.add(labelU2, 8, 2, 1, 1);
        gridPane.add(labelB2, 9, 2, 1, 1);
        gridPane.add(labelA2, 10, 2, 1, 1);
        gridPane.add(labelB3, 11, 2, 1, 1);
        gridPane.add(labelU3, 12, 2, 1, 1);
        gridPane.add(labelB4, 13, 2, 1, 1);
        gridPane.add(labelA3, 14, 2, 1, 1);
